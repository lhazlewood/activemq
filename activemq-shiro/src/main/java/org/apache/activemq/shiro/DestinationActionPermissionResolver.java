...
public class DestinationActionPermissionResolver implements ActionPermissionResolver {
     ...
     * </ul>
     * based on whether the {@link org.apache.activemq.shiro.DestinationAction#getDestination() destination} is
     ...
     * </li>
     * <li>
     * {@code actionVerb} is {@link org.apache.activemq.shiro.DestinationAction#getVerb() action.getVerb()}
     * </li>
     * </ol>
     * <h3>Examples</h3>
