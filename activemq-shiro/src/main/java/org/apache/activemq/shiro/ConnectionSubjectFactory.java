 ...
 * {@code Subject} instance and let a downstream {@link AuthenticationFilter} authenticate the {@code Subject} based on
...
public interface ConnectionSubjectFactory {
     ...
     * returned from this method to be anonymous until a downstream {@link AuthenticationFilter} authenticates the
