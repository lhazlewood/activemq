 ...
 * Whenever a {@link Subject} associated with a connection attempts to perform an {@link Action} (such as creating a
 ...
 * {@link #setActionPermissionResolver(ActionPermissionResolver) actionPermissionResolver}.  The
 ...
 * {@link DestinationActionPermissionResolver DestinationActionPermissionResolver}, which indicates which permissions
 ...
 * {@link DestinationActionPermissionResolver#createPermissionString createPermissionString} method
 * documentation valuable for understanding how destination actions are represented as permissions.
 *
 * @see ActionPermissionResolver
 * @see DestinationActionPermissionResolver
 * @since 5.9.0
 */
public class AuthorizationFilter extends EnvironmentFilter {
     ...
     * a {@link Subject} to perform a particular destination {@link Action}, (such as creating a
     ...
     *                                 {@link Action}, (such as creating a destination, or reading from a queue, etc).
     */
     ...
     * {@link ConnectionSubjectResolver}.
     *
